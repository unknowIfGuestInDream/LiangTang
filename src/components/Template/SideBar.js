    ...
    <section id="sidebar">
      ...
      <section className="blurb">
        ...
        <ul className="actions">
          <li>
            {!pathname.includes('/resume') ? <Link href="/resume" className="button">Learn More</Link> : <Link href="/about" className="button">About Me</Link>}
          </li>
        </ul>
      </section>
      <section id="footer">
        <ContactIcons />
        <p className="copyright">&copy; Liang Tang <Link href="/">tlcsdm.com</Link>. </p>
