...
const data: Project[] = [
  {
    ...
    date: '2021-06-18',
    desc: 'It is used to generate Java code through stored procedures of databases such as Oracle, and to generate CRUD stored procedures according to database tables, etc.',
    featured: true,
  },
  {
    title: 'javafxTool',
    ...
    date: '2022-10-16',
    desc: 'Scaffolding for JavaFX development based on JDK17, JavaFx21, controlsfx 11 and Maven.',
    featured: true,
  },
  {
    ...
    date: '2025-07-18',
    desc: 'OpenExplorer is a plugin for Eclipse, it opened the files selected in “Package Explorer” and “Navigator” in the system file browser.',
  },
  {
    ...
    date: '2025-07-18',
    desc: 'IconPreview is a lightweight Eclipse plugin that allows you to preview image files in the Eclipse "Package Explorer" view.',
  },
  {
    ...
    date: '2025-07-18',
    desc: 'This plugin integrates translation capabilities into the Eclipse IDE.',
  },
  {
    ...
    date: '2025-07-18',
    desc: 'Eclipse plugin provides awesome way to navigate your source code.',
  },
  {
    ...
    date: '2025-08-19',
    desc: 'Eclipse plugin to make Eclipse go fullscreen and save space.',
  },
  {
    ...
    date: '2025-08-19',
    desc: 'This plugin enhances code folding in Eclipse IDE.',
  },
  {
    ...
    date: '2025-12-16',
    desc: 'This plugin guesses the call parameters by the callee parameter names.',
  },
  {
    ...
    date: '2025-12-16',
    desc: 'This plugin generates call to setter method value for class.',
  },
  {
    ...
    date: '2025-12-16',
    desc: 'This plugin provides techniques to sort methods in Java classes, aiming to increase the readability of the source code.',
  },
  {
    ...
    date: '2025-12-16',
    desc: '能够自动将全角中文标点（如中文逗号、分号、句号、引号等）替换为半角标点。该工具帮助开发者在编码时保持标点统一，无需频繁切换输入法。',
  },
  {
    ...
    date: '2025-12-16',
    desc: 'Multiple cursor support for Eclipse IDE.',
  },
  {
    ...
    date: '2025-12-16',
    desc: "A plug-in that recreates IntelliJ IDEA's Maven View for Eclipse.",
  },
  {
    ...
    date: '2025-06-30',
    desc: 'Fork of Eclipse-Copyright-Generator for generating copyright headers.',
  },
  {
    ...
    image: '/images/projects/document.png',
    date: '2025-07-07',
    desc: "Registers Renesas project config files to open with Eclipse's XML editor.",
  },
  {
    ...
    image: '/images/projects/document.png',
    date: '2025-07-07',
    desc: 'Aggregation plugin containing development plugins used for Renesas QE development.',
  },
  {
    title: 'eclipse-bpep',
    ...
    date: '2025-08-24',
    desc: 'Builder Pattern Eclipse Plugin.',
  },
  {
    ...
    date: '2025-12-18',
    desc: 'Quick workspace file search plugin for Eclipse with instant results.',
  },
  {
    ...
    image: '/images/projects/fixcnchar.png',
    date: '2026-01-04',
    desc: 'VSCode plugin that replaces full-width Chinese punctuation with half-width punctuation.',
  },
  {
    ...
    image: '/images/projects/iconpreview.png',
    date: '2026-01-06',
    desc: 'IconPreview is a lightweight VSCode plugin that previews image files.',
  },
  {
    ...
    image: '/images/projects/translation.png',
    date: '2026-01-07',
    desc: 'VSCode plugin for translation.',
  },
  {
    ...
    image: '/images/projects/methodSorter.gif',
    date: '2026-01-10',
    desc: 'Sorts methods in Java classes to improve code readability in VSCode.',
  },
  {
    ...
    image: '/images/projects/autofill.gif',
    date: '2026-01-11',
    desc: 'Guesses Java call arguments based on callee parameter names in VSCode.',
  },
  {
    ...
    date: '2026-01-30',
    desc: 'Visualizes patch and diff files in VSCode.',
  },
  {
    ...
    date: '2026-02-05',
    desc: 'LVGL drag-and-drop code generation plugin for VSCode.',
  },
  {
    ...
    date: '2026-02-26',
    desc: 'JavaFX support plugin for VSCode.',
  },
  {
    ...
    date: '2026-03-08',
    desc: 'Displays color-coded git blame annotations in the VSCode editor gutter.',
  },
  {
    ...
    date: '2026-03-28',
    desc: 'Provides a visual tree view for browsing, searching, and querying JSON files.',
  },
  {
    title: 'tlstudio',
    subtitle: 'tlstudio',
    ...
    date: '2024-11-16',
    desc: 'Currently includes SWT examples, and will support JFace and other examples in the future.',
  },
  {
    title: 'Document',
    subtitle: 'Document',
